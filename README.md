...
Mestre Sara | Python | My most advanced discord bot, it usually gets updated before Providentia and then what went right is used as a way to improve Providentia. Currently this model can't run all functionalities on my own computer, locally, and I need to use cloud services. | Under development
