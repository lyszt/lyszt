...
Mestre Sara | Python | My most advanced discord bot, it usually gets updated before Providentia. Providentia then takes the light-weight functionalities and gets updated. Currently this model can't run locally all functionalities and I need to use cloud services for performance. | Under development
