...
Providentia SpySuite | HTML/CSS/JAVASCRIPT + Python + Django + React | Web app created to be used with the Discord bot, Providentia. It takes the information gotten from usuer input and translates it into a friendly interface.
...
Insight II | Python Kivy |  Insight is a desktop application designed to search, categorize and organize information. Utilizing automated web scraping technology, Insight digs deeper into diverse sources to extract relevant data. 
